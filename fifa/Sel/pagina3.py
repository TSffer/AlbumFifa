...
id_u = id_usuario[0][0]
queryS = "select nombreFigura , figurasAlbum.id from figurasAlbum join usuarios join figurasobtenidas on figurasAlbum.id = figurasobtenidas.id_figura and '%s' = figurasobtenidas.id_usuario  and figurasAlbum.id between 39 and 51 GROUP BY nombreFigura , figurasAlbum.id HAVING count(nombreFigura)>1 order by nombreFigura,figurasAlbum.id ASC " % id_u
...
<html lang="en">
  ...
  <body background="fondo.jpg">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="pagina2.py?user=%s"""%(user)+""" ">Prev
                <span class="sr-only">(current)</span>
              </a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="pagina4.py?user=%s"""%(user)+""" ">Next
                <span class="sr-only">(current)</span>
              </a>
            </li>
    ...
    <div class="container">
      ...
      <h1 class="my-4 text-center text-lg-left"><font Size="35" color=#2E86C1><i><b>Peru</b></i></font></h1>
